...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SDC_SLAVE_COUNT, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOFTDEVICE_CONTROLLER_CENTRAL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SCAN_NAME_CNT, 2);
